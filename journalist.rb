...
#Combien d'handle contiennent les 4 lettres du prénom "Aude" (sans faire attention à la casse) ?
...
puts ""
puts "Combien y'a t'il de journalistes dans cet array / ce tableau ?"
...
# je dois itérer sur l'array afin de tester si chaque élément contient un chiffr

number_of_journalist_with_number_in_username = 0
journalists.each do |journalist|
	if journalist =~ /\d/
		#number_of_journalist_with_number_in_username = number_of_journalist_with_number_in_username + 1
		number_of_journalist_with_number_in_username += 1
	end
end
...
number_of_journalist_with_lesquatrelettre = 0

journalists.each do |journalist|
	if journalist =~ /aude/
		number_of_journalist_with_lesquatrelettre += 1
	end
end
...
number_of_journalist_capitalized = 0

new_journalists = journalists.each do |journalist|
	journalist[0] = ""
end	

new_journalists.each do |new_journalist|
	if new_journalist.capitalize == new_journalist
		number_of_journalist_capitalized += 1
	end
end
puts number_of_journalist_capitalized
...
number_of_journalist_with_capsinside = 0

journalists.each do |journalist|
	if journalist =~ /[A-Z]/
		number_of_journalist_with_capsinside += 1
	end
end
...
number_of_journalist_with_lesunderscore = 0

arrayofjournalistswithanunderscore = journalists.each do |journalist|
	if journalist =~ /_/
		numberofunderscore = journalist.count('_')
		number_of_journalist_with_lesunderscore += numberofunderscore
	end		
end
